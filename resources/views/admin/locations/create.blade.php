...
<div class="min-h-screen bg-gray-50 py-12">
    <div class="max-w-2xl mx-auto px-4">
        <div class="bg-white rounded-lg shadow p-8">
            <a href="{{ route('admin.locations.index') }}" class="text-red-500 hover:text-red-600 mb-4 inline-block">
                ← Back to Locations
            </a>

            <h1 class="text-3xl font-bold text-gray-900 mb-6">Add New Location</h1>
            ...
            <form action="{{ route('admin.locations.store') }}" method="POST">
                ...
                <div class="flex gap-4">
                    <a href="{{ route('admin.locations.index') }}" class="px-6 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 font-bold">
                        Cancel
                    </a>
