        ...
        <div class="sidebar">
            <div class="sidebar-content">
                ...
                <div id="attractionDetails" class="attraction-panel hidden">
                    ...
                    <?php else: ?>
                    <p class="auth-prompt">
                        <a href="<?php echo e(route('login')); ?>">Sign in</a> to write a review
                    </p>
                    <?php endif; ?>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ridereview\resources\views/map/index.blade.php ENDPATH**/ ?>