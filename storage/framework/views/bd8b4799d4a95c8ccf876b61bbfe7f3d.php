...
<div class="min-h-screen bg-gradient-to-br from-red-500 via-pink-500 to-orange-500">
        ...
        <div class="max-w-6xl mx-auto flex justify-between items-center">
            ...
            <div class="flex gap-4">
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('dashboard')); ?>" class="px-6 py-2 bg-white text-red-500 rounded-lg font-bold hover:bg-gray-100 transition">
                        Dashboard
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="px-6 py-2 bg-white text-red-500 rounded-lg font-bold hover:bg-gray-100 transition">
                        Login
                    </a>
                    <a href="<?php echo e(route('register')); ?>" class="px-6 py-2 border-2 border-white text-white rounded-lg font-bold hover:bg-white hover:text-red-500 transition">
                        Register
                    </a>
                <?php endif; ?>
            </div>
        ...
        <div class="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div class="text-white">
                ...
                <div class="flex gap-4">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="px-8 py-4 bg-white text-red-500 rounded-lg font-bold text-lg hover:bg-gray-100 transition">
                        Get Started
                    </a>
                    <a href="<?php echo e(route('map.index')); ?>" class="px-8 py-4 border-2 border-white text-white rounded-lg font-bold text-lg hover:bg-white hover:text-red-500 transition">
                        Explore Map
                    </a>
                    <?php else: ?>
                    <a href="<?php echo e(route('map.index')); ?>" class="px-8 py-4 bg-white text-red-500 rounded-lg font-bold text-lg hover:bg-gray-100 transition">
                        View Map
                    </a>
                    <a href="<?php echo e(route('dashboard')); ?>" class="px-8 py-4 border-2 border-white text-white rounded-lg font-bold text-lg hover:bg-white hover:text-red-500 transition">
                        Dashboard
                    </a>
                    <?php endif; ?>
                </div>
    ...
    <div class="max-w-6xl mx-auto px-4 py-20">
        <div class="bg-white bg-opacity-10 backdrop-blur-md rounded-lg p-12 text-center border border-white border-opacity-20">
            ...
            <?php else: ?>
            <a href="<?php echo e(route('map.index')); ?>" class="inline-block px-8 py-4 bg-white text-red-500 rounded-lg font-bold text-lg hover:bg-gray-100 transition">
                Go to Map
            </a>
            <?php endif; ?>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ridereview\resources\views/welcome.blade.php ENDPATH**/ ?>